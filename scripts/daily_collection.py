#!/usr/bin/env python3
"""
📊 DAILY COLLECTION & SUMMARIZATION
Collects high-conviction candidates every 24h, generates summary report
"""
import subprocess
import json
import os
...
def save_daily_report(scored, timestamp):
    """Save daily report to file"""
    report_path = f'/home/ubuntu/trading_sniper/reports/daily_candidates_{timestamp.strftime("%Y-%m-%d")}.json'
...
def main():
    ...
    print(f"\n{'='*70}")
    print(f"📊 DAILY COLLECTION & SUMMARIZATION")
    ...
    # Save report
    print("\n📁 Saving daily report...")
    report_path = save_daily_report(scored, timestamp)
